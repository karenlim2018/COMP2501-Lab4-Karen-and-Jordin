...
/**
 * This class models a book store containing novels.
 *
...
class BookStore
{
    ...
    BookStore(final String bookStoreName)
    {
        ...
        System.out.println("Bookstore size: " + novels.size() + " novels" + "\n");
    }

    /**
     * Prints all novel titles that contain visible characters.
     */
    void printAllTitles()
    {
    ...
    /**
     * Prints all novel titles that contain visible characters,
     * if they contain the substring and match the case-sensitivity requirements.
     *
     * @param substring     A string of characters.
     * @param caseSensitive A boolean that determines if the substring is case-sensitive.
     */
    void printTitlesContaining(final String substring,
    ...
    /**
     * Prints all author names that contain visible characters and start or end with the substring,
     * regardless of case-sensitivity.
     *
     * @param substring A string of characters that is not case-sensitive.
     * @throws IllegalNameException If substring is null or blank.
     */
    void printNameStartsEndsWith(final String substring) throws IllegalNameException
    {
        if(substring == null ||
           substring.isBlank())
        {
    ...
    /**
     * A method to find the longest string value of various properties for the arrays in the list.
     *
     * @param property An argument that specifies which property of the arrays will be searched.
     * @return The longest string value in the list, based on the property.
     * Returns null if property is not title of author, case-insensitive.
     */
    String getLongest(final String property)
    {
        ...
        for(Novel novel: novels)
        {
            if(property.equalsIgnoreCase("author") &&
               ...
               novel.getAuthorName()   != null &&
              !novel.getAuthorName().isBlank() &&
               novel.getAuthorName().length() > x)
            {
                x = novel.getAuthorName().length();
            ...
            if(property.equalsIgnoreCase("title") &&
               ...
               novel.getTitle()   != null &&
              !novel.getTitle().isBlank() &&
               novel.getTitle().length() > x)
            {
                x = novel.getTitle().length();
